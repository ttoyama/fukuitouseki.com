...
福井県内の透析施設については、[福井県内透析施設一覧](../資料_福井県内透析施設一覧.md)をご参照ください。
...
- 避難所などで支給されそうな食品では塩分やカリウム含有量の多い食品に注意しましょう。詳細な食品栄養成分については、[透析患者向け食品栄養成分表](../資料_透析患者向け食品栄養成分表.md)を参照してください。
