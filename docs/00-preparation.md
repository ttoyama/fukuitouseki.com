...
- **災害時専用通信**：衛星電話、MCA無線等の準備・検討

**メーリングリストの活用**
災害時の確実な情報伝達のため、以下の用途でメーリングリストを活用します：
- 災害発生時の初動連絡・状況確認
- 標準報告書式による系統的情報収集
- 支援要請・受け入れ調整の効率化
- 復旧状況・再開情報の共有

本ネットワークは県内透析施設による任意の参加を基本としつつ、県内全施設に参加頂けるよう働きかけています。連絡先は1年に一回、福井県透析施設ネットワーク総会で定期的に更新し、災害時専用の連絡体制も併せて確認します。
